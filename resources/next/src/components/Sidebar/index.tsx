...
const menuGroups = [
    {
        ...
        menuItems: [
            ...
            },
            {
                ...
                route: "#",
                children: [
                    { label: "All Posts", route: "/blogs/all-posts" },
                    { label: "Add a New Post", route: "/blogs/new-post" },
                    { label: "Categories", route: "/blogs/categories" },
                ],
            },
            {
                icon: (
                ...
                route: "#",
                children: [
                    { label: "All Users", route: "/profile/all-user" },
                    { label: "Add New Users", route: "/profile/new-user" },
                    { label: "Profile", route: "/profile/profile-settings" },
                ],
            },
            {
                icon: (
